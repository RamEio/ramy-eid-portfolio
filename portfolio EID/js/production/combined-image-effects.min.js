// Production-optimized Image Grid Hover Effect
document.addEventListener('DOMContentLoaded', function() {
    try {
        ...
        const getPerfectLayout = (imageCount) => {
            const layouts = {
                3: [
                    { cols: 3, rows: 1, spans: [1, 1, 1] },
                    { cols: 1, rows: 3, spans: [1, 1, 1] },
                    { cols: 2, rows: 2, spans: [2, 1, 1] }
                ],
                4: [
                    { cols: 2, rows: 2, spans: [1, 1, 1, 1] },
                    { cols: 1, rows: 4, spans: [1, 1, 1, 1] }
                ],
                5: [
                    { cols: 3, rows: 2, spans: [2, 1, 1, 1, 1] },
                    { cols: 2, rows: 3, spans: [1, 1, 1, 1, 1] }
                ],
                6: [
                    { cols: 3, rows: 2, spans: [1, 1, 1, 1, 1, 1] },
                    { cols: 2, rows: 3, spans: [1, 1, 1, 1, 1, 1] },
                    { cols: 1, rows: 6, spans: [1, 1, 1, 1, 1, 1] }
                ],
                7: [
                    { cols: 3, rows: 3, spans: [2, 1, 1, 1, 1, 1, 1] },
                    { cols: 4, rows: 2, spans: [2, 1, 1, 1, 1, 1, 1] },
                    { cols: 2, rows: 4, spans: [1, 1, 1, 1, 1, 1, 1] }
                ],
                8: [
                    { cols: 3, rows: 3, spans: [2, 1, 1, 1, 1, 1, 1, 1] },
                    { cols: 4, rows: 2, spans: [1, 1, 1, 1, 1, 1, 1, 1] },
                    { cols: 2, rows: 4, spans: [1, 1, 1, 1, 1, 1, 1, 1] }
                ]
            };
        ...
        const createNewGrid = () => {
            try {
                ...
                // Randomize and select 3-7 images
